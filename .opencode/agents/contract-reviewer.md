---
description: client/, server/, HTTP, cookies, sessao e Socket.IO. Revisa
  mudancas de contrato quando um diff cruza frontend e backend ou quando houver
  risco de regressao de integracao. Pode ser chamado automaticamente ou usado
  diretamente em sessoes de review.
mode: subagent
temperature: 0.1
permission:
  "*": allow
