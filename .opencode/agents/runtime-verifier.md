---
description: npm run build, opencode debug config e validacao por pacote.
  Executa verificacoes focadas de build e configuracao depois de mudancas em
  codigo, docs de tooling ou contratos. Pode ser chamado automaticamente ou
  usado diretamente quando a sessao for so de validacao.
mode: subagent
temperature: 0.1
permission:
  "*": allow
